<template>
  <div>
    <XHeader  title="培训申请" :left-options="{showBack: true}"></XHeader>
    <div class="template">
      ...
      <group title=" ">
        <Cell  title="培训课程" :value="selectValue" is-link @click.native="select()"></Cell>
      </group>
      <group title=" ">
        <Cell  title="培训方式" :value="selectValue" is-link @click.native="select()"></Cell>
      </group>
      <group title=" ">
        <!--<Cell  title="培训费用" :value="selectValue" is-link @click.native="select()"></Cell>-->
        <x-input title="培训费用(元)" v-model="value" placeholder="请输入培训费用" text-align="right"></x-input>
      </group>
      <!--<group  title="请假原因">-->
