<template>
  <div>
    <XHeader  title="工作总结" :left-options="{showBack: true}"></XHeader>
    <div class="template">

      <group title=" ">
        <Cell  title="所属部门" :value="selectValue" is-link @click.native="select()"></Cell>
      </group>
      <group title=" ">
        <Cell  title="周期" :value="selectValue2" is-link @click.native="select2()"></Cell>
      </group>


      <group title="主要工作内容" class="tit">
        <x-textarea title="" placeholder="请输入"></x-textarea>
      </group>

      <group title="工作成效" class="tit">
        <x-textarea title="" placeholder="请输入"></x-textarea>
      </group>

      <group title="存在的不足" class="tit">
        <x-textarea title="" placeholder="请输入"></x-textarea>
      </group>
      <group title="需要支持帮助" class="tit">
        <x-textarea title="" placeholder="请输入"></x-textarea>
      </group>
      <group title="改进意见和建议" class="tit">
        <x-textarea title="" placeholder="请输入"></x-textarea>
      </group>
      <group title="下一周期工作目标" class="tit">
        <x-textarea title="" placeholder="请输入"></x-textarea>
      </group>
